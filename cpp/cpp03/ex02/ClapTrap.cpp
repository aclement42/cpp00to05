...
{
    if (_name == "")
        std::cout << "Default destructor called NONAMED!" << std::endl;
    else
...
void    ClapTrap::attack(const std::string & target)
{
    ...
    {
        if (this->_name == "")
           std::cout << "NONAMED: is no longer able to attack!" << std::endl;
        else
    ...
    else
    {
        this->_EP--;
        if (this->_name == "")
            std::cout << "NONAMED: attacks " << target << ", causing " <<  this->_AD << " points of damage." << std::endl;
        else
...
{
        if (this->_name == "")
            std::cout << "NONAMED: takes " << amount << " points of damage." << std::endl;
        else
...
void    ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        if (this->_name == "")
            std::cout << "NONAMED: is no longer able to repair!" << std::endl;
        else
    ...
    else
    {
        ...
        this->_EP--;
        if (this->_name == "")
            std::cout << "NONAMED: repairs itself and regains " << amount << " points of HP." << std::endl;
        else
